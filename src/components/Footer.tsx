        ...
        <footer className="lato">
                    ...
                    <div
                        ...
                        <div className="space-y-3 sm:space-y-4">
                                ...
                                <Link href="/">
                                    <div className="flex items-center mb-3 sm:mb-4 cursor-pointer">
                                        <Image
                                            ...
                                            alt={footerData.logo.alt || "Acorn Travels Logo"}
                                            width={200}
                                            height={160}
                            ...
                            <p className="text-[13px] sm:text-[14px] lg:text-[15px] font-normal leading-7 text-justify">
                                {footerData.description || "Acorn Travels, a trusted and IATA-accredited travel agency established in 1973,\n" +
                                    "                                specializes in delivering exceptional travel experiences across both leisure and\n" +
                                    "                                corporate sectors. With a steadfast commitment to personalized service."}
                            </p>
                            <div className="flex flex-row gap-1">
                                {footerData.certifications && footerData.certifications.map((cert, index) => (
                                    <Image
                                        key={index}
                                        src={urlFor(cert).url()}
                        ...
                        <div>
                            ...
                            <ul className="px-3 sm:px-5 list-disc space-y-1 sm:space-y-2 text-[#E2E2E2] text-[13px] sm:text-[14px] md:text-[15px]  lato font-normal">
                                {footerData.ourServices && footerData.ourServices.map((service: {
                                    ...
                                    <li key={index}>
                                        <Link href={service.href} className="hover:text-white">{service.label}</Link>
                                    </li>
                                ))}
                        ...
                        <div className="md:-ml-6">
                            ...
                            <ul className="space-y-2 sm:space-y-3 md:space-y-4 text-[#E2E2E2] text-[13px] sm:text-[14px] md:text-[15px]">
                                ...
                                {/*    <li key={index} className="flex items-start gap-2 sm:gap-3 md:gap-4 font-normal">*/}
                                {/*        {contact.icon && (*/}
                                {/*            <Image*/}
                                {/*                src={urlFor(contact.icon).url()}*/}
                                {/*                alt={contact.icon.alt || contact.type}*/}
                                {/*                width={24}*/}
                                {/*                height={24}*/}
                                ...
                                {/*        <div>*/}
                                {/*            {*/}
                                {/*                if (contact.linkPrefix && contact.type !== 'location'){*/}
                            ...
                            <div
                                ...
                                <div className="flex space-x-3 sm:space-x-4 md:space-x-5">
                                    {footerData.socialLinks && footerData.socialLinks.map((social, index) => (
                                        <Link key={index} href={social.url} target="_blank" className="hover:opacity-80"
                                    ...
                                    {/*    </svg>*/}
                                    {/*</Link>*/}
                                    {/*<Link href="https://www.linkedin.com/company/acorntravels/"*/}
            ...
            <div
                ...
                <div
                    ...
                    {footerData.bottomLinks && footerData.bottomLinks.map((link: {
                        href: string;
                        label: string;
                    }, index: Key) => (
                        <Link key={index} href={link.href} className="hover:underline font-normal">{link.label}</Link>
                    ))}
