...
const Hero = ({hero}: HeroProps) => {
    ...
    return (
        <div className="relative w-full h-[400px] md:h-[600px] lg:h-[790px] overflow-hidden lato" ref={ref}>
            <motion.div
            ...
            >
                ...
                >
                    <motion.h1
                        className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-semibold text-white mb-3 md:mb-4 lg:mb-6 max-w-5xl leading-6 md:leading-15"
                        variants={contentVariants}
                    >
                        {hero.title}
                    </motion.h1>
                    <motion.p
                        className="text-sm sm:text-base md:text-xl text-[#D3D1D1] font-medium mb-4 md:mb-6 lg:mb-8 max-w-xl leading-5 md:leading-7 lg:max-w-2xl"
                        variants={contentVariants}
                    >
                        {hero.description}
                    </motion.p>
