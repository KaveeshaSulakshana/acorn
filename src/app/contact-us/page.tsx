                    ...
                    >
                        <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-6 lg:pr-8 xl:pr-12">
                           ...
                           max-w-xl leading-relaxed mb-6 sm:mb-8"
                            ...
                            {(branches.length > 0 ? branches : fallbackBranches).slice(0, 1).map((branch, index) => (
                            ...
                            <div className="mb-6 sm:mb-8">
                                <div className="flex flex-col sm:flex-row sm:gap-8 lg:gap-12">
                                    {(branches.length > 0 ? branches : fallbackBranches)
                                        .slice(1)
                                        .map((branch, index) => (
                                            <div key={index} className="flex flex-col mb-6 sm:mb-0">
                                                <h3
                                                    className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl
                                             text-[#3C3C3C] mb-3 sm:mb-4"
                                                >
                                                ...
                                                <div className="flex gap-3 sm:gap-4 items-start mb-3 sm:mb-4">
                                                    ...
                                                    <p
                                                        className="text-[#737373] leading-relaxed font-normal text-xs sm:text-sm md:text-base max-w-56 sm:max-w-64"
                                                    >
                                                        {branch.address}
                                                    </p>
                                                </div>
